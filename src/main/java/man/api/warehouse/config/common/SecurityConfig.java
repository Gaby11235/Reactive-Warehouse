package man.api.warehouse.config.common;
...
class SecurityConfig {
        ...
        return http
                ...
                .authorizeExchange(it ->
                        it.pathMatchers("/", "/login", "/logout").permitAll()
                                .pathMatchers(org.springframework.http.HttpMethod.GET, "/posts/**").permitAll()
                                .pathMatchers(org.springframework.http.HttpMethod.DELETE, "/posts/**").hasRole("ADMIN")
    ...
    public AuthenticationWebFilter loginFilter(ReactiveAuthenticationManager authenticationManager,
        ...
        filter.setRequiresAuthenticationMatcher(pathMatchers(org.springframework.http.HttpMethod.POST, "/login"));
    ...
    public LogoutWebFilter logoutFilter() {
        ...
        filter.setLogoutHandler((webFilterExchange, authentication) ->
                webFilterExchange.getExchange().getSession()
                        .flatMap(WebSession::invalidate).then() // 使Web会话失效
        );
